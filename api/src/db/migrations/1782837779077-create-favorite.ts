...
export async function down(db: Kysely<any>): Promise<void> {
  await db.schema.dropIndex('favorites_guest_id_place_id_unique').execute()
  await db.schema.dropIndex('favorites_guest_id').execute()
  await db.schema.dropIndex('favorites_place_id').execute()
