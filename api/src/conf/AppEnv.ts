...
class AppEnvClass extends Env<{
  boolean: 'CONSOLE_SERVICE' | 'CLIENT' | 'DB_NO_SSL' | 'REQUEST_LOGGING' | 'WEB_SERVICE' | 'WORKER_SERVICE' | 'WS_SERVICE'

  integer: 'BG_JOBS_REDIS_PORT' | 'DB_PORT' | 'DREAM_PARALLEL_TESTS' | 'REPLICA_DB_PORT' | 'WS_PORT' | 'WS_REDIS_PORT'
