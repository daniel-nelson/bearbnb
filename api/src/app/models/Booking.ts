...
export default class Booking extends ApplicationModel {
  ...
  @deco.HasOne('Review', { dependent: 'destroy' })
  public review: Review

  @deco.Validate()
  public validateCheckoutDateAfterCheckinDate(this: Booking) {
    if (!this.startsOn || !this.endsOn || this.endsOn.valueOf() > this.startsOn.valueOf()) return

    this.addError('endsOn', 'must be after startsOn')
  }
}
