...
# pending future work
pnpm psy g:resource v1/guest/bookings Booking Guest:belongs_to Place:belongs_to arrive_on:date depart_on:date adults:integer cubs:integer deleted_at:date:optional
```
