...
export const useGetV1GuestReviews = createSdkStore(sdk.getV1GuestReviews)
export const usePostV1GuestReviews = createSdkStore(sdk.postV1GuestReviews)
export const useDeleteV1GuestReviewsById = createSdkStore(sdk.deleteV1GuestReviewsById)
export const usePatchV1GuestReviewsById = createSdkStore(sdk.patchV1GuestReviewsById)
export const useGetV1Host = createSdkStore(sdk.getV1Host)
export const usePatchV1Host = createSdkStore(sdk.patchV1Host)
export const usePostV1Host = createSdkStore(sdk.postV1Host)
...
export const useGetV1VisitorPlacesByIdAvailability = createSdkStore(sdk.getV1VisitorPlacesByIdAvailability)
export const useGetV1VisitorPlacesByPlaceIdReviews = createSdkStore(sdk.getV1VisitorPlacesByPlaceIdReviews)
